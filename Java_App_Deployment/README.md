...
-------
    git clone https://github.com/Ameekh-Rifa/Java-Project-DevOps.git
...
--------------
    docker build -t ameekhrifa/kubernetes-configmap-reload .
...
-----------
    docker push kubernetes-configmap-reload
